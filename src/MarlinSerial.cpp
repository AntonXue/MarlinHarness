...
// Anton: Maybe comment this so we can actually get code to fucking compile.
  ...
  // Anton: We don't know what a String is -- some Arduino magic.
  /*
  ...
  */
  ...
  // Anton: ghetto ass additions
  write(const char* str) { while (*str) write(*str++); }
...
// Give some really stupid definitions.
  ...
  void MarlinSerial::print(const char* c) {}
  void MarlinSerial::print(char c, int b) {}
  void MarlinSerial::print(unsigned char c, int b) {}
  void MarlinSerial::print(int i, int b) {}
  void MarlinSerial::print(unsigned int i, int b) {}
  void MarlinSerial::print(long l, int b) {}
