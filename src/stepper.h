  ...
  private:
    ...
    static FORCE_INLINE unsigned short calc_timer(unsigned short step_rate) {
      ...
      if (step_rate >= (8 * 256)) { // higher step rate
        // Anton: typing problem required to compile.
        // unsigned short table_address = (unsigned short)&speed_lookuptable_fast[(unsigned char)(step_rate >> 8)][0];
        const uint16_t* table_address = &speed_lookuptable_fast[(unsigned char)(step_rate >> 8)][0];
        ...
        // Anton: typing problem required to compile. Same thing as above.
        // unsigned short table_address = (unsigned short)&speed_lookuptable_slow[0][0];
        const uint16_t* table_address = &speed_lookuptable_slow[0][0];
